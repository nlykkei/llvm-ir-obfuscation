; ModuleID = 'programs/c/fac.c'
source_filename = "programs/c/fac.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [19 x i8] c"Compute factorial\0A\00", align 1
...
@.str.3 = private unnamed_addr constant [55 x i8] c"Invalid argument: <num> must be a nonnegative integer\0A\00", align 1
...
if.then4:                                         ; preds = %if.end
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.3, i32 0, i32 0))
  call void @help()
  store i32 -1, i32* %retval, align 4
  br label %return
